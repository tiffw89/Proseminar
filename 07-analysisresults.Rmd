...
4. \[ \text{logit} \left({\pi} \right) = `r round(coef(summary(glm11))[,1][1], 2)`  `r round(coef(summary(glm11))[,1][3], 2)` {\text{Small}} `r round(coef(summary(glm11))[,1][2], 2)` {\text{Medium}} `r round(coef(summary(glm11))[,1][4], 2)` \text{Warned} + `r round(coef(summary(glm11))[,1][5], 2)` \text{Ingested} \]
