...
|${\sf Logit}\hat{P}(Y \le j)$ | Intercept | Day | Dusk | Night |
|---|---|---|---|---|
|${\sf Logit}\hat{P}(Y \le 1)$|`r round(ctable1[4],2)`|`r round(ctable1[1],2)`|`r round(ctable1[2],2)`|`r round(ctable1[3],2)`|
|${\sf Logit}\hat{P}(Y \le 2)$|`r round(ctable1[5],2)`|`r round(ctable1[1],2)`|`r round(ctable1[2],2)`|`r round(ctable1[3],2)`|
|${\sf Logit}\hat{P}(Y \le 3)$|`r round(ctable1[6],2)`|`r round(ctable1[1],2)`|`r round(ctable1[2],2)`|`r round(ctable1[3],2)`|
|${\sf Logit}\hat{P}(Y \le 4)$|`r round(ctable1[7],2)`|`r round(ctable1[1],2)`|`r round(ctable1[2],2)`|`r round(ctable1[3],2)`|
      
|${\sf Logit}\hat{P}(Y \le j)$ | Intercept |Overcast | SomeClouds |
|---|---|---|---|
|${\sf Logit}\hat{P}(Y \le 1)$|`r round(ctable2[3],2)`|`r round(ctable2[1],2)`|`r round(ctable2[2],2)`|
|${\sf Logit}\hat{P}(Y \le 2)$|`r round(ctable2[4],2)`|`r round(ctable2[1],2)`|`r round(ctable2[2],2)`|
|${\sf Logit}\hat{P}(Y \le 3)$| `r round(ctable2[5],2)`|`r round(ctable2[1],2)`|`r round(ctable2[2],2)`|
|${\sf Logit}\hat{P}(Y \le 4)$|`r round(ctable2[6],2)`|`r round(ctable2[1],2)`|`r round(ctable2[2],2)`|

|${\sf Logit}\hat{P}(Y \le j)$ | Intercept | Small| Medium |
|---|---|---|---|
|${\sf Logit}\hat{P}(Y \le 1)$|`r round(ctable4[3],2)`|`r round(ctable4[2],2)`|`r round(ctable4[1],2)`|
|${\sf Logit}\hat{P}(Y \le 2)$|`r round(ctable4[4],2)`|`r round(ctable4[2],2)`|`r round(ctable4[1],2)`|
|${\sf Logit}\hat{P}(Y \le 3)$|`r round(ctable4[5],2)`|`r round(ctable4[2],2)`|`r round(ctable4[1],2)`|
|${\sf Logit}\hat{P}(Y \le 4)$|`r round(ctable4[6],2)`|`r round(ctable4[2],2)`|`r round(ctable4[1],2)`|

|${\sf Logit}\hat{P}(Y \le j)$ | Intercept | Warned|
|---|---|---|
|${\sf Logit}\hat{P}(Y \le 1)$|`r round(ctable5[2],2)`|`r round(ctable5[1],2)`|
|${\sf Logit}\hat{P}(Y \le 2)$|`r round(ctable5[3],2)`|`r round(ctable5[1],2)`|
|${\sf Logit}\hat{P}(Y \le 3)$|`r round(ctable5[4],2)`|`r round(ctable5[1],2)`|
|${\sf Logit}\hat{P}(Y \le 4)$|`r round(ctable5[5],2)`|`r round(ctable5[1],2)`|

|${\sf Logit}\hat{P}(Y \le j)$ | Intercept | Ingested|
|---|---|---|
|${\sf Logit}\hat{P}(Y \le 1)$|`r round(ctable3[2],2)`|`r round(ctable2[1],2)`|
|${\sf Logit}\hat{P}(Y \le 2)$|`r round(ctable3[3],2)`|`r round(ctable2[1],2)`|
|${\sf Logit}\hat{P}(Y \le 3)$|`r round(ctable3[4],2)`|`r round(ctable2[1],2)`|
|${\sf Logit}\hat{P}(Y \le 4)$|`r round(ctable3[5],2)`|`r round(ctable2[1],2)`|
...
#### Adjusted associations: Multiple Regression: Damage Level*
