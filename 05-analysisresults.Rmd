...
Results are shown as the odds ratio with its 95% confidence interval. Both unadjusted and adjusted analyses were conducted. Statistical significance was defined \textit{a priori} as $p<0.05$.
...
${\sf Logit}\hat{P}(Y \le 1) = `r round(ctable2[4],2)`  `r round(ctable2[1],2)`\text{Day}  `r round(ctable2[2],2)`\text{Dusk}  `r round(ctable2[3],2)`\text{Night}$

${\sf Logit}\hat{P}(Y \le 2)  = `r round(ctable2[5],2)` `r round(ctable2[1],2)`\text{Day}  `r round(ctable2[2],2)`\text{Dusk}  `r round(ctable2[3],2)`\text{Night}$

${\sf Logit}\hat{P}(Y \le 3) = `r round(ctable2[6],2)` `r round(ctable2[1],2)`\text{Day}  `r round(ctable2[2],2)`\text{Dusk}  `r round(ctable2[3],2)`\text{Night}$

${\sf Logit}\hat{P}(Y \le 4) =   `r round(ctable2[7],2)` `r round(ctable2[1],2)`\text{Day}  `r round(ctable2[2],2)`\text{Dusk}  `r round(ctable2[3],2)`\text{Night}$

${\sf Logit}\hat{P}(Y \le 1) = `r round(ctable2[3],2)` + `r round(ctable2[1],2)`\text{Overcast} + `r round(ctable2[2],2)`\text{SomeClouds}$

${\sf Logit}\hat{P}(Y \le 2) = `r round(ctable2[4],2)` + `r round(ctable2[1],2)`\text{Overcast} + `r round(ctable2[2],2)`\text{SomeClouds}$

${\sf Logit}\hat{P}(Y \le 3) = `r round(ctable2[5],2)` + `r round(ctable2[1],2)`\text{Overcast} + `r round(ctable2[2],2)`\text{SomeClouds}$

${\sf Logit}\hat{P}(Y \le 4) =  `r round(ctable2[6],2)` + `r round(ctable2[1],2)`\text{Overcast} + `r round(ctable2[2],2)`\text{SomeClouds}$

${\sf Logit}\hat{P}(Y \le 1) = `r round(ctable2[3],2)` + `r round(ctable2[2],2)`\text{Small} + `r round(ctable2[1],2)`\text{Medium}$

${\sf Logit}\hat{P}(Y \le 2) =  `r round(ctable2[4],2)` + `r round(ctable2[2],2)`\text{Small} + `r round(ctable2[1],2)`\text{Medium}$

${\sf Logit}\hat{P}(Y \le 3) = `r round(ctable2[5],2)` + `r round(ctable2[2],2)`\text{Small} + `r round(ctable2[1],2)`\text{Medium}$

${\sf Logit}\hat{P}(Y \le 4) = `r round(ctable2[6],2)` + `r round(ctable2[2],2)`\text{Small} + `r round(ctable2[1],2)`\text{Medium}$

${\sf Logit}\hat{P}(Y \le 1) = `r round(ctable2[2],2)`  + `r round(ctable2[1],2)`\text{Warned}$

${\sf Logit}\hat{P}(Y \le 2) = `r round(ctable2[3],2)` + `r round(ctable2[1],2)`\text{Warned}$

${\sf Logit}\hat{P}(Y \le 3) = `r round(ctable2[4],2)`  + `r round(ctable2[1],2)`\text{Warned}$

${\sf Logit}\hat{P}(Y \le 4) = `r round(ctable2[5],2)`  + `r round(ctable2[1],2)`\text{Warned}$

${\sf Logit}\hat{P}(Y \le 1) = `r round(ctable2[2],2)`  + `r round(ctable2[1],2)`\text{Ingested}$

${\sf Logit}\hat{P}(Y \le 2) = `r round(ctable2[3],2)` + `r round(ctable2[1],2)`\text{Ingested}$

${\sf Logit}\hat{P}(Y \le 3) = `r round(ctable2[4],2)`  + `r round(ctable2[1],2)`\text{Ingested}$

${\sf Logit}\hat{P}(Y \le 4) =   `r round(ctable2[5],2)`  + `r round(ctable2[1],2)`\text{Ingested}$
...
*Multiple Regression Model: Damage Level*
...
*Interpretation: Multiple Regression: Damage Level*
