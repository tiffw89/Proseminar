...
\[ H_0:{\text{OR}}_i = {\text{OR}}_i^{(0)} | OR_i≥ {\text{OR}}_i^{(0)}|OR_i≤{\text{OR}}_i^{(0)} \]

\[ H_1:{\text{OR}}_i = {\text{OR}}_i^{(0)} | OR_i≥ {\text{OR}}_i^{(0)}|OR_i≤{\text{OR}}_i^{(0)} \]

- The test statistic is defined by the following equation: \[ z_0 = \frac{ \hat{\beta}_i-\text{ln}{\text{(OR)}_i^{(0)}}}{\text{SE}_{\hat{\beta}_i}} \]
